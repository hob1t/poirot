...
public final class TestUtils {
  ...
  public static AlumniOf createAlumniOf() {
    ...
    alumniOf.setAdditionalProperty(
        RandomStringUtils.randomAlphabetic(STR_LEN), RandomStringUtils.randomAlphabetic(STR_LEN));
  ...
  public static ReviewedBy createReviewedBy() {
    ...
    reviewedBy.setAdditionalProperty(
        RandomStringUtils.randomAlphabetic(STR_LEN), RandomStringUtils.randomAlphabetic(STR_LEN));
    return reviewedBy;
  }
