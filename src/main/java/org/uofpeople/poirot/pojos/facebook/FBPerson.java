...
public class FBPerson {
  ...
  /**
   * {"page_name":"Page Not Found"," location":"None", "email":"None", "phone_number":"None",
   * "social_media_links":"None", "page_website":"None", "page_category":"None",
   * "page_likes":"None", "page_followers":"None"}
   *
   * @param person
   * @return
   */
