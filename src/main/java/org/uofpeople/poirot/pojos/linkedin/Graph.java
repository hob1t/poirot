...
@JsonPropertyOrder({"@type", "address", "alumniOf", "awards", "image", "jobTitle", "name", "sameAs", "url", "memberOf",
		"worksFor", "knowsLanguage", "disambiguatingDescription", "interactionStatistic", "description", "reviewedBy"})
public class Graph {
